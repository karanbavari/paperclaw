...
- installed adapter list for this PaperClaw instance
...
## 8. New Skill: `paperclaw-create-agent`

Create new skill directory:

- `skills/paperclaw-create-agent/SKILL.md`
- `skills/paperclaw-create-agent/references/api-reference.md`
...
Also update `skills/paperclaw/SKILL.md` to reference this skill for hiring workflows.
...
- `paperclaw-create-agent` skill + docs updates
