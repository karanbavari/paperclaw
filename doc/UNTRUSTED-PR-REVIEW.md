...
This is intentionally separate from the normal PaperClaw dev image.
...
```sh
review-checkout-pr karanbavari/paperclaw 432
cd /work/checkouts/paperclaw-paperclaw/pr-432
```
...
## Preview the PaperClaw app from the PR
...
- PaperClaw's embedded PostgreSQL and local storage stay inside the container home volume via `PAPERCLAW_HOME=/home/reviewer/.paperclaw-review`.
