# Google RCS Business Messaging Communication Tools

Use the PaperClaw Google RCS Business Messaging plugin for governed communication workflows.

## Scope
- Region: Global
- Capabilities: rcs-send, events, files, testers, agents
