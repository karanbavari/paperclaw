# Resend Communication Tools

Use the PaperClaw Resend plugin for governed communication workflows.

## Scope
- Region: Global
- Capabilities: email-send, domains, contacts, audiences, broadcasts
