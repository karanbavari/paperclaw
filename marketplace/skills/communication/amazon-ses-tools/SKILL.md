# Amazon SES Communication Tools

Use the PaperClaw Amazon SES plugin for governed communication workflows.

## Scope
- Region: Global
- Capabilities: email-send, templates, identities, suppression-list
