# Brevo Communication Tools

Use the PaperClaw Brevo plugin for governed communication workflows.

## Scope
- Region: Global/EU
- Capabilities: email-send, contacts, campaigns, templates, senders
