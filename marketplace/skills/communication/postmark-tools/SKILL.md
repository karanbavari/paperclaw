# Postmark Communication Tools

Use the PaperClaw Postmark plugin for governed communication workflows.

## Scope
- Region: Global
- Capabilities: email-send, templates, servers, suppressions
