# Mailgun Communication Tools

Use the PaperClaw Mailgun plugin for governed communication workflows.

## Scope
- Region: Global/US/EU
- Capabilities: email-send, domains, templates, events, suppressions
