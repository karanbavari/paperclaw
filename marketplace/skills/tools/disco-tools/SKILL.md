---
name: disco-tools
description: Use the PaperClaw DISCO Legal & Law plugin to let agents operate official DISCO APIs.
---

# DISCO Tools

Use this skill when a marketplace micro-service agent needs to connect a PaperClaw company to DISCO for legal operations workflows.

## Setup

1. Install and enable the `@kesarcloud/plugin-disco` plugin.
