---
name: clio-tools
description: Use the PaperClaw Clio Legal & Law plugin to let agents operate official Clio APIs.
---

# Clio Tools

Use this skill when a marketplace micro-service agent needs to connect a PaperClaw company to Clio for legal operations workflows.

## Setup

1. Install and enable the `@kesarcloud/plugin-clio` plugin.
