---
name: asana-tools
description: Use the PaperClaw Asana productivity plugin to let agents operate official Asana APIs.
---

# Asana Tools

Use this skill when a marketplace micro-service agent needs to connect a
PaperClaw company to Asana.

## Setup

1. Install and enable the `@kesarcloud/plugin-asana` plugin.
