---
name: everlaw-tools
description: Use the PaperClaw Everlaw Legal & Law plugin to let agents operate official Everlaw APIs.
---

# Everlaw Tools

Use this skill when a marketplace micro-service agent needs to connect a PaperClaw company to Everlaw for legal operations workflows.

## Setup

1. Install and enable the `@kesarcloud/plugin-everlaw` plugin.
