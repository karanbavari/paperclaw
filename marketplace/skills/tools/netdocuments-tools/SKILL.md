---
name: netdocuments-tools
description: Use the PaperClaw NetDocuments Legal & Law plugin to let agents operate official NetDocuments APIs.
---

# NetDocuments Tools

Use this skill when a marketplace micro-service agent needs to connect a PaperClaw company to NetDocuments for legal operations workflows.

## Setup

1. Install and enable the `@kesarcloud/plugin-netdocuments` plugin.
