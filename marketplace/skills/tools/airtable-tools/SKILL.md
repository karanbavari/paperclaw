---
name: airtable-tools
description: Use the PaperClaw Airtable productivity plugin to let agents operate official Airtable APIs.
---

# Airtable Tools

Use this skill when a marketplace micro-service agent needs to connect a
PaperClaw company to Airtable.

## Setup

1. Install and enable the `@kesarcloud/plugin-airtable` plugin.
