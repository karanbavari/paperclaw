---
name: docusign-tools
description: Use the PaperClaw DocuSign Legal & Law plugin to let agents operate official DocuSign APIs.
---

# DocuSign Tools

Use this skill when a marketplace micro-service agent needs to connect a PaperClaw company to DocuSign for legal operations workflows.

## Setup

1. Install and enable the `@kesarcloud/plugin-docusign` plugin.
