---
name: clickup-tools
description: Use the PaperClaw ClickUp productivity plugin to let agents operate official ClickUp APIs.
---

# ClickUp Tools

Use this skill when a marketplace micro-service agent needs to connect a
PaperClaw company to ClickUp.

## Setup

1. Install and enable the `@kesarcloud/plugin-clickup` plugin.
