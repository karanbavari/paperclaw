---
name: imanage-tools
description: Use the PaperClaw iManage Legal & Law plugin to let agents operate official iManage APIs.
---

# iManage Tools

Use this skill when a marketplace micro-service agent needs to connect a PaperClaw company to iManage for legal operations workflows.

## Setup

1. Install and enable the `@kesarcloud/plugin-imanage` plugin.
