---
name: pandadoc-tools
description: Use the PaperClaw PandaDoc Legal & Law plugin to let agents operate official PandaDoc APIs.
---

# PandaDoc Tools

Use this skill when a marketplace micro-service agent needs to connect a PaperClaw company to PandaDoc for legal operations workflows.

## Setup

1. Install and enable the `@kesarcloud/plugin-pandadoc` plugin.
