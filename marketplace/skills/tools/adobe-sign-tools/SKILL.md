---
name: adobe-sign-tools
description: Use the PaperClaw Adobe Sign Legal & Law plugin to let agents operate official Adobe Sign APIs.
---

# Adobe Sign Tools

Use this skill when a marketplace micro-service agent needs to connect a PaperClaw company to Adobe Sign for legal operations workflows.

## Setup

1. Install and enable the `@kesarcloud/plugin-adobe-sign` plugin.
