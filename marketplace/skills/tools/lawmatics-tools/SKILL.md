---
name: lawmatics-tools
description: Use the PaperClaw Lawmatics Legal & Law plugin to let agents operate official Lawmatics APIs.
---

# Lawmatics Tools

Use this skill when a marketplace micro-service agent needs to connect a PaperClaw company to Lawmatics for legal operations workflows.

## Setup

1. Install and enable the `@kesarcloud/plugin-lawmatics` plugin.
