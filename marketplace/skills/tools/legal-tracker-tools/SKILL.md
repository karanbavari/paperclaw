---
name: legal-tracker-tools
description: Use the PaperClaw Legal Tracker Legal & Law plugin to let agents operate official Legal Tracker APIs.
---

# Legal Tracker Tools

Use this skill when a marketplace micro-service agent needs to connect a PaperClaw company to Legal Tracker for legal operations workflows.

## Setup

1. Install and enable the `@kesarcloud/plugin-legal-tracker` plugin.
