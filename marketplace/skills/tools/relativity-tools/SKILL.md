---
name: relativity-tools
description: Use the PaperClaw Relativity Legal & Law plugin to let agents operate official Relativity APIs.
---

# Relativity Tools

Use this skill when a marketplace micro-service agent needs to connect a PaperClaw company to Relativity for legal operations workflows.

## Setup

1. Install and enable the `@kesarcloud/plugin-relativity` plugin.
