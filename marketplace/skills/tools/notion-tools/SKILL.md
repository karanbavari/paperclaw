---
name: notion-tools
description: Use the PaperClaw Notion productivity plugin to let agents operate official Notion APIs.
---

# Notion Tools

Use this skill when a marketplace micro-service agent needs to connect a
PaperClaw company to Notion.

## Setup

1. Install and enable the `@kesarcloud/plugin-notion` plugin.
