---
name: gitlab-tools
description: Use the PaperClaw GitLab Developer plugin to operate official GitLab APIs with dry-run guardrails.
---

# GitLab Tools

Use this skill when a PaperClaw company needs governed developer-platform automation through GitLab.

## Setup

1. Install and enable the `@kesarcloud/plugin-gitlab` plugin.
