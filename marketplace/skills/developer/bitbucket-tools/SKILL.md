...
description: Use the PaperClaw Bitbucket Developer plugin to operate official Bitbucket APIs with dry-run guardrails.
---

# Bitbucket Tools

Use this skill when a PaperClaw company needs governed developer-platform automation through Bitbucket.

## Setup

1. Install and enable the `@kesarcloud/plugin-bitbucket` plugin.
