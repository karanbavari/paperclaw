---
name: figma-tools
description: Use the PaperClaw Figma Developer plugin to operate official Figma APIs with dry-run guardrails.
---

# Figma Tools

Use this skill when a PaperClaw company needs governed developer-platform automation through Figma.

## Setup

1. Install and enable the `@kesarcloud/plugin-figma` plugin.
