---
name: supabase-tools
description: Use the PaperClaw Supabase Developer plugin to operate official Supabase APIs with dry-run guardrails.
---

# Supabase Tools

Use this skill when a PaperClaw company needs governed developer-platform automation through Supabase.

## Setup

1. Install and enable the `@kesarcloud/plugin-supabase` plugin.
