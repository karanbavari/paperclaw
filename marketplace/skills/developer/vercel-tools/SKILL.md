---
name: vercel-tools
description: Use the PaperClaw Vercel Developer plugin to operate official Vercel APIs with dry-run guardrails.
---

# Vercel Tools

Use this skill when a PaperClaw company needs governed developer-platform automation through Vercel.

## Setup

1. Install and enable the `@kesarcloud/plugin-vercel` plugin.
