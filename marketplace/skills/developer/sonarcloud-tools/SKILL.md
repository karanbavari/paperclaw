...
description: Use the PaperClaw SonarCloud Developer plugin to operate official SonarCloud APIs with dry-run guardrails.
---

# SonarCloud Tools

Use this skill when a PaperClaw company needs governed developer-platform automation through SonarCloud.

## Setup

1. Install and enable the `@kesarcloud/plugin-sonarcloud` plugin.
