---
name: render-tools
description: Use the PaperClaw Render Developer plugin to operate official Render APIs with dry-run guardrails.
---

# Render Tools

Use this skill when a PaperClaw company needs governed developer-platform automation through Render.

## Setup

1. Install and enable the `@kesarcloud/plugin-render` plugin.
