---
name: github-tools
description: Use the PaperClaw GitHub Developer plugin to operate official GitHub APIs with dry-run guardrails.
---

# GitHub Tools

Use this skill when a PaperClaw company needs governed developer-platform automation through GitHub.

## Setup

1. Install and enable the `@kesarcloud/plugin-github` plugin.
