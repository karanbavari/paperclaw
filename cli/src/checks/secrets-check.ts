...
export function secretsCheck(config: PaperClawConfig, configPath?: string): CheckResult {
  ...
  if (provider !== "local_encrypted") {
    return {
      ...
      canRepair: false,
      repairHint: "Run `paperclaw configure --section secrets` and set provider to local_encrypted",
    };
  }
