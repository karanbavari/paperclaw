...
- [ ] The first paragraph points at the PaperClaw skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the PaperClaw execution contract verbatim:
...
- [ ] Adapter config matches this PaperClaw instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
