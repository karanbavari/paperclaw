...
Eval framework for testing PaperClaw agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the PaperClaw heartbeat skill:
