...
import type { PluginCategory, PluginStatus, PaperClawPluginManifestV1 } from "@kesarcloud/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<PaperClawPluginManifestV1>().notNull(),
