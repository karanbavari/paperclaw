...
const PLUGIN_ID = "paperclaw.fake-sandbox-provider";
...
const manifest: PaperClawPluginManifestV1 = {
  ...
  description:
    "First-party deterministic sandbox provider plugin for exercising PaperClaw provider-plugin integration without external infrastructure.",
  author: "PaperClaw",
