...
import type { PaperClawPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@kesarcloud/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: PaperClawPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@kesarcloud/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
