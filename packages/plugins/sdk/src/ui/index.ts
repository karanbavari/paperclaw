/**
 * `@kesarcloud/plugin-sdk/ui` — PaperClaw plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@kesarcloud/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@kesarcloud/plugin-sdk/ui";
 *
 ...
 * - `useHostNavigation()` — navigate PaperClaw-internal links through the host router
