/**
 * `definePlugin` — the top-level helper for authoring a PaperClaw plugin.
 *
...
// ---------------------------------------------------------------------------
// PaperClawPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface PaperClawPlugin {
 ...
 * @returns A sealed `PaperClawPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@kesarcloud/plugin-sdk";
