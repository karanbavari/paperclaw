 ...
 * channel.
 *
 * The PaperClaw plugin runtime uses JSON-RPC 2.0 over stdio to communicate
 ...
 * we use strings (UUIDs or monotonic counters) for all PaperClaw messages.
 */
...
/**
 * PaperClaw plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this PaperClaw instance. */
    instanceId: string;
    /** Semver version of the running PaperClaw host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
