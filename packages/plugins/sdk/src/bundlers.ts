/**
 * Bundling presets for PaperClaw plugins.
 *
 ...
 * to match the PaperClaw plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@kesarcloud/plugin-sdk/ui",
    "@kesarcloud/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
  ...
  const esbuildManifest: EsbuildLikeOptions = {
    ...
    target: "node20",
    sourcemap,
    external: ["@kesarcloud/plugin-sdk"],
  };
