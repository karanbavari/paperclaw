...
import { ensurePathInEnv } from "@kesarcloud/adapter-utils/server-utils";
...
async function readSandboxCursorRuntimeInfo(input: {
  ...
  const homeMarker = "__PAPERCLAW_CURSOR_HOME__:";
  const preferredMarker = "__PAPERCLAW_CURSOR_AGENT__:";
  try {
