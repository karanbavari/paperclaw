import type { Project } from "@kesarcloud/shared";

export const PROJECT_ORDER_UPDATED_EVENT = "paperclaw:project-order-updated";
const PROJECT_ORDER_STORAGE_PREFIX = "paperclaw.projectOrder";
