...
export interface PaperClawIssueRuntimeReassignment {
  assigneeAgentId: string | null;
  assigneeUserId: string | null;
}

export interface PaperClawIssueRuntimeSendOptions {
  body: string;
  reopen?: boolean;
  reassignment?: PaperClawIssueRuntimeReassignment;
}

interface UsePaperClawIssueRuntimeOptions {
  messages: readonly ThreadMessage[];
  isRunning: boolean;
  onSend: (options: PaperClawIssueRuntimeSendOptions) => Promise<void>;
...
export function usePaperClawIssueRuntime({
  messages,
  isRunning,
  onSend,
  onCancel,
}: UsePaperClawIssueRuntimeOptions) {
