...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "@kesarcloud/shared";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in PaperClaw file storage for ${selectedCompany.name}.`
    : "Select a company to upload an avatar into PaperClaw storage.";
