...
export function IssueDetail() {
  ...
  const attachmentUploadButton = (
    <>
      ...
      >
        <PaperClaw className="h-3.5 w-3.5 mr-1.5" />
      ...
      {showRichSubIssuesSection ? (
        <div className="space-y-3">
          ...
          <IssuesList
            ...
            viewStateKey={`paperclaw:issue-detail:${issue.id}:subissues-view`}
        ...
        <TabsContent value="chat">
          {detailTab === "chat" ? (
            <IssueDetailChatTab
              ...
              userLabelMap={userLabelMap}
              userProfileMap={userProfileMap}
              draftKey={`paperclaw:issue-comment-draft:${issue.id}`}
