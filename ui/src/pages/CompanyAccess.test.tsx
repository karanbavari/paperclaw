...
vi.mock("@/context/CompanyContext", () => ({
  useCompany: () => ({
    ...
    selectedCompany: { id: "company-1", name: "PaperClaw" },
  }),
}));
      ...
      members: [
        {
          ...
          user: {
            id: "user-1",
            email: "codexcoder@kesarcloud.local",
            name: "Codex Coder",
            image: null,
          },
          grants: [],
    ...
    listJoinRequestsMock.mockResolvedValue([
      {
        ...
        requestEmailSnapshot: "board@kesarcloud.local",
