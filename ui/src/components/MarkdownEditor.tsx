...
import { buildAgentMentionHref, buildProjectMentionHref, buildUserMentionHref } from "@kesarcloud/shared";
  ...
  if (richEditorError) {
    return (
      <div
        ref={containerRef}
        className={cn(
          "relative paperclaw-mdxeditor-scope",
  ...
  return (
    ...
    >
      <MDXEditor
        ...
        className={cn("paperclaw-mdxeditor", !bordered && "paperclaw-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "paperclaw-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
