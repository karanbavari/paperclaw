...
const mockCompanyState = vi.hoisted(() => ({
  companies: [{ id: "company-1", issuePrefix: "PAP", name: "PaperClaw" }],
  selectedCompany: { id: "company-1", issuePrefix: "PAP", name: "PaperClaw" },
...
describe("Layout", () => {
  ...
  beforeEach(() => {
    ...
    mockCompanyState.companies = [{ id: "company-1", issuePrefix: "PAP", name: "PaperClaw" }];
    mockCompanyState.selectedCompany = { id: "company-1", issuePrefix: "PAP", name: "PaperClaw" };
  ...
  it("uses the route company context for plugin route sidebars on the first render", async () => {
    ...
    mockCompanyState.companies = [
      { id: "company-1", issuePrefix: "PAP", name: "PaperClaw" },
