        ...
        <main className="paperclaw-story__inner space-y-6">
          <section className="paperclaw-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="paperclaw-story__label">Issue management</div>
          ...
          <section className="grid gap-4 md:grid-cols-3">
            {[
              ...
              const Icon = item.icon;
              return (
                <Card key={item.label} className="paperclaw-story__frame shadow-none">
                  <CardHeader>
      ...
      <div className="paperclaw-story">
        <main className="paperclaw-story__inner space-y-6">
          <section className="paperclaw-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="paperclaw-story__label">IssueRunLedger</div>
