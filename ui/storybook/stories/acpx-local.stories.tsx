...
import type { AdapterConfigSchema, CreateConfigValues } from "@kesarcloud/adapter-utils";
import { parseAcpxStdoutLine } from "@kesarcloud/adapter-acpx-local/ui";
import type {
  Agent,
  AgentSkillSnapshot,
...
const acpxLocalConfigSchema: AdapterConfigSchema = {
  fields: [
    ...
    },
    {
      ...
      hint: "Fallback if the ACP agent asks for input outside an interactive session. PaperClaw still auto-approves permissions by default.",
    },
    {
      key: "cwd",
      label: "Working directory",
      type: "text",
      hint: "Absolute fallback directory. PaperClaw execution workspaces can override this at runtime.",
    },
    {
      key: "stateDir",
      label: "State directory",
      type: "text",
      hint: "Optional ACPX session state directory. Defaults to PaperClaw-managed company/agent scoped storage.",
    },
    {
      key: "fastMode",
...
const acpxSkillsCompanyLibrary: CompanySkillListItem[] = [
  {
    ...
    name: "PaperClaw",
    description:
      "Coordination skill: heartbeats, checkout, comments, and routine API patterns for PaperClaw agents.",
    sourceType: "local_path",
    sourceLocator: "skills/paperclaw",
    sourceRef: null,
  ...
  },
  {
    ...
    name: "Design guide",
    description:
      "PaperClaw UI design system reference: tokens, typography, status colors, and reusable component patterns.",
    sourceType: "local_path",
...
function buildAcpxClaudeSnapshot(): AgentSkillSnapshot {
  return {
    ...
    supported: true,
    mode: "ephemeral",
    desiredSkills: ["paperclaw", "design-guide"],
    warnings: [],
    entries: [
      {
        key: "paperclaw",
        ...
        managed: true,
        required: true,
        requiredReason: "PaperClaw coordination skill is mandatory for control-plane agents.",
        state: "configured",
  ...
  return {
    ...
    entries: [
      ...
      },
      {
        ...
        targetPath: null,
        detail:
          "Desired state is stored in PaperClaw only; custom ACP commands need an explicit skill integration contract before runtime sync is available.",
      },
      {
        key: "mobile-app-qa",
        runtimeName: "mobile-app-qa",
...
function AcpxClaudeSkillsStory() {
  ...
  return (
    <StoryFrame
      ...
      subtitle="Runtime-synced state. Selected skills are mounted into the next ACPX Claude session via the PaperClaw skills directory."
    >
...
function AcpxCustomSkillsStory() {
  ...
  return (
    <StoryFrame
      ...
      subtitle="Unsupported runtime sync. Desired skills are tracked in PaperClaw only until a custom ACP command declares a skill integration contract."
    >
