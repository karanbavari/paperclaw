...
import type { CompanySearchResult, CompanySearchResponse } from "@kesarcloud/shared";
...
import { storybookAgents, storybookProjects, storybookIssues } from "../fixtures/paperclawData";
...
function SearchStories() {
  return (
    <div className="paperclaw-story">
      <main className="paperclaw-story__inner max-w-[1320px] space-y-6">
        ...
        <section className="paperclaw-story__frame overflow-hidden">
          <div className="paperclaw-story__title-block">
            <div className="paperclaw-story__label">/search</div>
        ...
        <section className="paperclaw-story__frame overflow-hidden">
          ...
          <SearchPagePreview response={{ ...fixtureResponse, results: [], countsByType: { issue: 0, agent: 0, project: 0, meeting: 0, memory: 0 } }} state="empty" query="ghostbuster" />
        </section>

        <section className="paperclaw-story__frame overflow-hidden p-4">
          <div className="paperclaw-story__title-block">
            <div className="paperclaw-story__label">Match-source chips</div>
        ...
        <section className="paperclaw-story__frame overflow-hidden p-4">
          <div className="paperclaw-story__title-block">
            <div className="paperclaw-story__label">Cmd+K palette</div>
        ...
        <section className="paperclaw-story__frame overflow-hidden p-4">
          <div className="paperclaw-story__title-block">
            <div className="paperclaw-story__label">Search result row</div>
