...
import { AGENT_STATUSES, ISSUE_PRIORITIES, ISSUE_STATUSES } from "@kesarcloud/shared";
import type {
...
import { createIssue } from "../fixtures/paperclawData";
    ...
    <div className="paperclaw-story">
      <main className="paperclaw-story__inner space-y-6">
        <section className="paperclaw-story__frame p-6">
          <div className="paperclaw-story__label">Language</div>
