...
const storybookRepoRoot = "~/paperclaw";
...
export const storybookCompanies: Company[] = [
  ...
  },
  {
    ...
    attachmentMaxBytes: 10 * 1024 * 1024,
    requireBoardApprovalForNewAgents: true,
    requireBoardApprovalForCeoSkillInstalls: true,
    feedbackDataSharingEnabled: false,
    feedbackDataSharingConsentAt: null,
    feedbackDataSharingConsentByUserId: null,
    feedbackDataSharingTermsVersion: null,
...
export const storybookAgents: Agent[] = [
  {
    ...
    status: "running",
    reportsTo: "agent-cto",
    capabilities: "Ships full-stack PaperClaw product tasks, Storybook coverage, and verification.",
...
export const storybookGoals: Goal[] = [
  {
    ...
    description: "Make PaperClaw the control plane operators trust for autonomous AI companies.",
    level: "company",
    status: "active",
    parentId: null,
  ...
  },
  {
    ...
    runtimeServices: [
      createRuntimeService({
        ...
        cwd: null,
        port: 4173,
        url: "https://paperclaw-docs-preview.vercel.app",
