/**
 * Server-side SVG renderer for PaperClaw org charts.
...
// PaperClaw logo: scaled icon (~16px) + wordmark (13px), vertically centered
const PAPERCLAW_LOGO_SVG = `<g>
  ...
  <text x="22" y="11.5" font-family="system-ui, -apple-system, sans-serif" font-size="13" font-weight="600" fill="currentColor">PaperClaw</text>
</g>`;
