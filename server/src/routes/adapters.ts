 ...
 * toggle server-side adapter code for the whole PaperClaw instance.
 *
...
interface AdapterInstallRequest {
  /** npm package name (e.g., "droid-paperclaw-adapter") or local path */
  packageName: string;
...
export function adapterRoutes() {
  ...
  // without modifying PaperClaw's source code.
  //
