...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@kesarcloud/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: PaperClawPluginManifestV1, pluginDbId?: string): void;
