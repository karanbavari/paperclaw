...
import type { CreateIssueThreadInteraction, IssueDocumentSummary } from "@kesarcloud/shared";
 ...
 *
 * This implementation delegates to the core PaperClaw domain services,
...
export function buildHostServices(
  ...
  options: { pluginWorkerManager?: PluginWorkerManager; manifest?: import("@kesarcloud/shared").PaperClawPluginManifestV1 } = {},
