/**
 * PluginEventBus — typed in-process event bus for the PaperClaw plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@kesarcloud/shared";
import type { PluginEvent, EventFilter } from "@kesarcloud/plugin-sdk";
