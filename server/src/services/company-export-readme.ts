 ...
 */
import type { CompanyPortabilityManifest } from "@kesarcloud/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [PaperClaw](https://github.com/karanbavari/paperclaw)");
  lines.push("");
