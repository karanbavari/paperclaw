...
import { documentRevisions, documents, issueDocuments, issues } from "@kesarcloud/db";
import { isSystemIssueDocumentKey, issueDocumentKeySchema } from "@kesarcloud/shared";
