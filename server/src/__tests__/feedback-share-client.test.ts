...
describe("feedback trace share client", () => {
  ...
  it("defaults to telemetry.github.com/karanbavari/paperclaw when no backend url is configured", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith(
      "https://telemetry.github.com/karanbavari/paperclaw/feedback-traces",
  ...
  it("wraps the feedback trace payload as gzip+base64 json before upload", async () => {
    const client = createFeedbackTraceShareClientFromConfig({
      feedbackExportBackendUrl: "https://telemetry.github.com/karanbavari/paperclaw",
    ...
    expect(call?.[0]).toBe("https://telemetry.github.com/karanbavari/paperclaw/feedback-traces");
