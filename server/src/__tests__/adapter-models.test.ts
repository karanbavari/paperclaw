...
import { models as codexFallbackModels } from "@kesarcloud/adapter-codex-local";
import { models as cursorFallbackModels } from "@kesarcloud/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@kesarcloud/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@kesarcloud/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.PAPERCLAW_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.PAPERCLAW_OPENCODE_COMMAND = "__paperclaw_missing_opencode_command__";
