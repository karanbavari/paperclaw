...
- `PAPERCLAW_APPROVAL_ID` — the resolved approval
- `PAPERCLAW_APPROVAL_STATUS` — `approved` or `rejected`
- `PAPERCLAW_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
