...
- Running a Python script that calls the PaperClaw API
...
1. PaperClaw spawns the configured command as a child process
2. Standard PaperClaw environment variables are injected (`PAPERCLAW_AGENT_ID`, `PAPERCLAW_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the PaperClaw API and perform work.
