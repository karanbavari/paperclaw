...
summary: Set up PaperClaw for local development
---

Run PaperClaw locally with zero external dependencies.
...
No Docker or external database required. PaperClaw uses embedded PostgreSQL automatically.
...
To open PaperClaw to a private network with login enabled:
